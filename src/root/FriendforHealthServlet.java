...
/**
 * Servlet implementation class FriendforHealthServlet
 */
@WebServlet("/FriendforHealthServlet")
public class FriendforHealthServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//	System.out.println("hello4");
			...
			RequestDispatcher rd=getServletContext().getRequestDispatcher("/ViewHealthData.jsp");
			...
			System.out.println(" Caught in FriendforHealthexception");
			e.printStackTrace();
		} 
