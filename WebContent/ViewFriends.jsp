...
<body>
	<% //List Containing the Name Of Your Friends
		List<String> friends = (List<String>) request.getAttribute("friendlist");
		String message = (String) request.getAttribute("message");
		if (message.equals("NO Friends")) {
			// Displays message if donot have any friend
	%>
	<h1 style="color: red;">CURRENTLY YOU DON'T HAVE ANY FRIEND !!!!</h1>
	<%
		} else {
			// display list of all your friends
	%>

	<form action="UnfriendServlet" method="post" name="register">
