...
<body>
	...
	<form action="CreateForumServlet" method="post" name="createforum">

		<h2>Create New Forum Here!!</h2>
			...
			<label for="name">TITLE:</label>
			 <input type="text" id="title"
				name="forumtitle" required="required">
				 <label for="url">
				URL:</label> <input type="text" id="forumurl" 
				name="forum_url" required="required"> 
				 <label for="summary">
				SUMMARY:</label> <input type="text" id="forumsummary" 
				name="forum_summary" required="required"> 
